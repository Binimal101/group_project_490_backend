...
class Account(SQLModelLU, table=True):
  ...
  # role relations
  client_id: Optional[int] = Field(default=None, foreign_key="client.id", ondelete="CASCADE") # all roles are clients by default
  coach_id: Optional[int] = Field(default=None, foreign_key="coach.id", ondelete="CASCADE")
