...
To test out most endpoints, you need to create an account, most routes are protected in the role system, you must first create an account in the /auth category, then you can authorize yourself in the top right corner with the unm/pw; we encrypt as soon as the info comes in.
